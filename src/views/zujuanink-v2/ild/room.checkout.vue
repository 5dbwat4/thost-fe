  ...
  <div class="block_main">
    <div v-for="(i, index) in TList">
      <div :id="'DrawableBlock-' + index">
        ...
        <question-block :qcontent="i"/>
        <answer-img :id="i.qid" :width="700" />
      </div>
    </div>
    <div>
...
import { NSpace, NEllipsis, NButton, NDivider,NAlert,NCard,NModal,NSpin,NP } from "naive-ui";
import AnswerImg from "./room.answerImgHelper.vue";
import questionBlock from "./cmp.questionBlockBasic.ild.vue"
...
//     }
    ...
    const imgData=await generateImg(i)
...
const SubmitToFailedColl=async(i)=>{
