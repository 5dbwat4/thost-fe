<template>
      ...
      >
       ...
       <head-theme-2  v-if="titleformat % titleformatCount == 2" :data="GroupDataPassed"/>
        ...
        <div
          ...
          :data_id="i"
        >
        <block-theme-0 :normalizeFun="normalizeq"  v-if="infoformat % infoformatCount == 0" :data="oo" :index="i"/>
        <block-theme-1 :normalizeFun="normalizeq"  v-if="infoformat % infoformatCount == 1" :data="oo" :index="i"/>
        <block-theme-2 :normalizeFun="normalizeq"  v-if="infoformat % infoformatCount == 2" :data="oo" :index="i"/>
  ...
  import { normalizeqWordTailored as normalizeq} from "../../../shared/normalize_q/toWordUse"
